...
public class GroupTest {
  ...
  public void success_AddGroup1() {
    Group group1 = Group.fromAffine(new Field(new BigInteger("10")), new Field(new BigInteger("20")));
    Group group2 = Group.fromAffine(new Field(new BigInteger("20")), new Field(new BigInteger("30")));
  ...
  public void success_AddGroup2() {
    Group group1 = Group.fromAffine(new Field(new BigInteger("141")), new Field(new BigInteger("24")));
    Group group2 = Group.fromAffine(new Field(new BigInteger("23")), new Field(new BigInteger("43")));
  ...
  public void success_AddGroup3() {
    Group group1 = Group.fromAffine(new Field(new BigInteger("13411")), new Field(new BigInteger("24312")));
    Group group2 = Group.fromAffine(new Field(new BigInteger("23423")), new Field(new BigInteger("43423")));
  ...
  public void success_AddGroup4() {
    Group group1 = Group.fromAffine(new Field(new BigInteger("93481")), new Field(new BigInteger("94823")));
    Group group2 = Group.fromAffine(new Field(new BigInteger("238534")), new Field(new BigInteger("64234")));
  ...
  public void success_EncodeGroup_9() {
    ...
    Group group = Group.fromAffine(new Field(x), new Field(y));
